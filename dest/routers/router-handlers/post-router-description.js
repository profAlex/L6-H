...
const createNewComment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!postId) {
        console.error({
            message: "Missing required parameter: postId inside createNewComment handler",
    ...
    if (typeof postId !== "string" || postId.trim().length === 0) {
        console.error({
            message: "Required parameter has incorrect format: 'postId' inside createNewComment handler",
    ...
    if (!req.body) {
        console.error({
            message: "Required parameter is missing: 'req.body' inside createNewComment handler",
    ...
    if (!content) {
        console.error({
            message: "Required parameter is missing: 'content' inside createNewComment handler",
    ...
    if (typeof content !== "string" || content.trim().length === 0) {
        console.error({
            message: "Required parameter has incorrect format: 'content' inside createNewComment handler",
